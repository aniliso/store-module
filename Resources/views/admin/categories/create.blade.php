...
@section('content-header')
    <h1>
        {{ trans('store::categories.title.create category') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.store.category.index') }}">{{ trans('store::categories.title.categories') }}</a></li>
        <li class="active">{{ trans('store::categories.title.create category') }}</li>
    </ol>
@stop
        ...
        <div class="col-md-10">
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="box-body">
                        {!! Form::normalSelect("parent_id", trans('store::categories.form.parent'), $errors, $categoryList, null, ['class'=>'category ui fluid multiple search normal selection dropdown']) !!}
                    </div>
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('store::admin.categories.partials.create-fields', ['lang' => $locale])
                        </div>
                    @endforeach
        ...
        <div class="col-md-2">
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <hr/>
                    @mediaSingle('productCategoryImage', null, null, trans('store::categories.form.image'))
                </div>
            </div>
            <div class="box box-primary">
                <div class="box-body">
