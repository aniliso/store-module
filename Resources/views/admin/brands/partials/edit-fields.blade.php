<div class="box-body">
    {!! Form::i18nInput("title", trans('store::products.form.title'), $errors, $lang, $brand, ['data-slug'=>'source']) !!}

    {!! Form::i18nInput("slug", trans('store::products.form.slug'), $errors, $lang, $brand, ['data-slug'=>'target']) !!}
    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="desc_{{ $lang }}">
                {!! Form::i18nTextarea("description", trans('store::products.form.description'), $errors, $lang, $brand) !!}
            </div>
