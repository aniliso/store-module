    ...
    <div class="c-layout-page">
        ...
        <div class="container">
            <div class="c-layout-sidebar-menu c-theme ">
                ...
                <ul class="c-sidebar-menu c-bg-dark-1 m-bot-0 hidden-xs">
                    <li class="c-dropdown c-font-white c-font-bold" style="padding: 15px 25px;">
            ...
            <div class="c-layout-sidebar-content ">
                                ...
                                <div class="c-content-overlay">
                                    ...
                                    <div class="c-overlay-wrapper">
                                        <div class="c-overlay-content">
                                            <a href="{{ $product->present()->url }}" class="btn btn-md c-btn-grey-1 c-btn-uppercase c-btn-bold c-btn-border-1x c-btn-square">{{ trans('store::stores.title.review') }}</a>
                                        </div>
                                    </div>
                                    <div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 230px; background-image: url({{ $product->present()->firstImage(276, 230, 'resize', 90) }});"></div>
                                </div>
                                <div class="c-info">
                                    <p class="c-title c-font-14 c-font-slim"><a href="{{ $product->present()->url }}">{{ $product->title }}</a></p>
                                </div>
                            </div>
                        </div>
                        @endif
                ...
                <div class="c-margin-t-20 m-bot-20"></div>
                @if($products)
